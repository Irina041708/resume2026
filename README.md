...
# Публикация проекта
Settings-->Pages-->main(master)-->save
У себя на десктопе создаем ветку,коммитим-создаем пул реквест отправляем себе на гитхаб в ветку мастер от себя из только что созданной ветки
